...
function AboutMe({ setVisible }: { setVisible: React.Dispatch<React.SetStateAction<boolean>> }) {
  ...
  useGSAP(() => {
    ...
    bgTimeline
      .to("#hero", 
        { backgroundColor: "#776e99", ease: "none", duration: 0.4 }
      )
      .to("#hero", 
        { backgroundColor: "var(--blue)", duration: 0.6, ease: "power2.out" }
      );
    
    bgTimeline.eventCallback("onUpdate", function () {
      const heroElement = document.getElementById("hero");
      if (heroElement) {
        const currentColor = getComputedStyle(heroElement).backgroundColor;
    ...
    // animation for experience title to change color
    gsap.to(
      "#experience-title",
      {
        color: "var(--background-exp)",
        ease: "power1.in",
        scrollTrigger: {
          trigger: "#hero+aboutme",
          start: `86% bottom`,
        ...
        <div id="hero" className="sticky inset-0 h-screen w-screen overflow-hidden object-cover">
          ...
          <div
            ...
            style={{
              ...
              maskPosition: `center ${aboutMeTitleTopPosition * 100}%`,
              maskSize: "contain",
            }}
          >
            ...
            <div style={{paddingTop: `${aboutMeTitleTopPosition * 100 + 2}vh`}}>
              <div className="flex justify-center items-center gap-x-5 p-4 px-10">
                ...
                <div id="bio" className="z-50 flex flex-col gap-y-4 text-2xl max-w-[50%] text-fg-aboutme-text" >
                  <p>
                    Hey!! My name is Joanna and I&apos;m a <span className="text-fg-aboutme-highlight">CS</span> student at the <span className="text-fg-aboutme-highlight">University of Waterloo</span>.
                  </p>
                  <p>
                    I love going to <span className="text-fg-aboutme-highlight">hackathons</span>, and I&apos;m an active contributor to <span className="text-fg-aboutme-highlight">open source software</span>.
                  </p>
                  <p>
            ...
            <svg width="0" height="0">
              <mask id="title-mask" maskContentUnits="objectBoundingBox">
                <rect width="1" height="1" fill="white" />
                <text
                  x="0.5"
                  y={aboutMeTitleTopPosition}
                  fill="black"
                  textAnchor="middle"
                  ...
                  transform="translate(0.5, 0.25) scale(1, 1.5) translate(-0.5, -0.25)"
                >
                  About Me
                </text>
              </mask>
          ...
          <div>
            <p id="experience-title" className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-8xl font-bold font-title-impact pointer-events-none z-22 text-fg-exp-orange" style={{opacity: 0}}>
              Experience
            </p>
          </div>
        </div>
