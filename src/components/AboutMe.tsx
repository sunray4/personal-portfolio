  ...
  return (
    <div id="aboutme" className="relative h-[300vh]">
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <svg width="1257px" height="1040px" viewBox="0 0 1257 1040" className="absolute top-0 right-0" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
